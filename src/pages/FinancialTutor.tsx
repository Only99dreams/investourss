        ...
        <div className="container mx-auto px-4 min-h-16 py-3 flex flex-wrap items-center justify-between gap-x-4 gap-y-2">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2 min-w-0">
              <img src={investoursLogo} alt="Investours" className="w-8 h-8 shrink-0" />
              <div className="min-w-0">
                <h1 className="font-semibold text-foreground text-sm sm:text-base truncate">AI Financial Tutor</h1>
