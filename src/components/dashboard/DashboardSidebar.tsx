...
const sidebarItems = [
  ...
  { icon: HeartPulse, label: "Health Guidance", path: "/dashboard/health-guidance", subtitle: "Guidance & Reports" },
  ...
  { icon: PieChart, label: "FHA Portfolio", path: "/dashboard/fha-portfolio", subtitle: "Earnings & Rewards" },
